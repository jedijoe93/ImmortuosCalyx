...
public class Register {
    ...
    public static final RegistryObject<Item> SCANNER = ITEMS.register("healthscanner", () -> new BaseItems(TextFormatting.BLUE + "Gives you information about infection levels in players, and yourself", TextFormatting.GRAY + "Shift rightclick to view your stats, left click players to view theirs", "", ""));
